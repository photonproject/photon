...
const QString BITCOIN_IPC_PREFIX("universalmolecule:");
...
{
    QString name("UniversalMoleculeQt");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click universalmolecule: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start universalmolecule: click-to-pay handler");
    else
...
{
    // clicking on universalmolecule: URLs creates FileOpen events on the Mac:
