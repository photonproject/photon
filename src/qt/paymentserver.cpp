...
const QString BITCOIN_IPC_PREFIX("photon:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click photon: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start photon: click-to-pay handler");
    else
...
{
    // clicking on photon: URLs creates FileOpen events on the Mac:
